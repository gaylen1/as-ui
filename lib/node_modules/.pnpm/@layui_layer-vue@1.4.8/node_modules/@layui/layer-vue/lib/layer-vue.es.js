...
var _sfc_main$7 = vue.defineComponent(_objectSpread$7(_objectSpread$7({}, __default__$6), {}, {
  props: {
    opacity: null,
    index: null,
    visible: {
...
var _sfc_main$6 = vue.defineComponent(_objectSpread$6(_objectSpread$6({}, __default__$5), {}, {
  props: {
    src: null
  },
...
var _sfc_main$5 = vue.defineComponent(_objectSpread$5(_objectSpread$5({}, __default__$4), {}, {
  props: {
    title: {
  ...
  setup: function setup3(__props) {
    ...
    return function(_ctx, _cache) {
      return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$4, vue.toDisplayString(renderContent(__props.title)), 1);
    };
  }
}));
...
var _sfc_main$4 = vue.defineComponent(_objectSpread$4(_objectSpread$4({}, __default__$3), {}, {
  props: {
    closeBtn: {
  ...
  setup: function setup4(__props, _ref) {
    ...
    return function(_ctx, _cache) {
      return vue.openBlock(), vue.createElementBlock("a", {
        class: vue.normalizeClass(["layui-layer-ico layui-layer-close layui-layer-close" + __props.closeBtn]),
        href: "javascript:;",
        onClick: closeHandle
      }, null, 2);
    };
...
var _sfc_main$2 = vue.defineComponent(_objectSpread$3(_objectSpread$3({}, __default__$2), {}, {
  props: {
    imgList: null,
    startIndex: {
      default: 0
  ...
  setup: function setup5(__props, _ref) {
    var emit = _ref.emit;
    var props = __props;
    var index2 = vue.ref(props.startIndex);
    vue.watch(index2, function() {
    ...
    var showLayerImgBar = vue.ref(false);
    vue.onMounted(function() {
      vue.nextTick(function() {
        showLayerImgBar.value = true;
      });
    });
    var ifSetThumb = vue.computed(function() {
      var res = false;
    ...
    return function(_ctx, _cache) {
      return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$2, [vue.createElementVNode("img", {
        src: __props.imgList[index2.value].src
      }, null, 8, _hoisted_2$2), __props.imgList.length > 0 ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_3$2, [__props.imgList.length > 1 ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_4$1, [vue.createElementVNode("a", {
        href: "javascript:;",
      ...
      })])) : vue.createCommentVNode("", true), __props.imgList.length > 1 || __props.imgList[index2.value].alt ? (vue.openBlock(), vue.createElementBlock("div", {
        key: 1,
        class: "layui-layer-imgbar",
        style: vue.normalizeStyle({
          opacity: showLayerImgBar.value ? 1 : 0
        })
      }, [vue.unref(ifSetThumb) ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_5, [(vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(__props.imgList, function(item, i) {
      ...
      }, null, 4)])) : (vue.openBlock(), vue.createElementBlock("span", _hoisted_8, [__props.imgList[index2.value].alt ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_9, vue.toDisplayString(__props.imgList[index2.value].alt), 1)) : vue.createCommentVNode("", true), __props.imgList.length > 1 ? (vue.openBlock(), vue.createElementBlock("em", _hoisted_10, vue.toDisplayString(index2.value + 1) + " / " + vue.toDisplayString(__props.imgList.length), 1)) : vue.createCommentVNode("", true)]))], 4)) : vue.createCommentVNode("", true)])) : vue.createCommentVNode("", true)]);
    };
  }
}));
...
var _sfc_main$1 = vue.defineComponent(_objectSpread$2(_objectSpread$2({}, __default__$1), {}, {
  props: {
    title: null,
    content: null,
    isHtmlFragment: {
  ...
  setup: function setup6(__props, _ref) {
    var emit = _ref.emit;
    var notifyRef = vue.shallowRef(null);
    ...
    return function(_ctx, _cache) {
      return vue.openBlock(), vue.createElementBlock("div", {
        ...
        ref_key: "notifyRef",
        ref: notifyRef
      }, [vue.createElementVNode("h2", _hoisted_1$1, [__props.icon ? (vue.openBlock(), vue.createElementBlock("i", {
        key: 0,
        class: vue.normalizeClass(__props.iconClass)
      }, null, 2)) : vue.createCommentVNode("", true), vue.createTextVNode(" " + vue.toDisplayString(__props.title), 1)]), !__props.isHtmlFragment ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_2$1, [vue.createElementVNode("p", null, vue.toDisplayString(__props.content), 1)])) : (vue.openBlock(), vue.createElementBlock("div", {
        key: 1,
        class: "content",
        innerHTML: __props.content
      }, null, 8, _hoisted_3$1)), vue.createVNode(_sfc_main$4, {
        onClick: close2
      })], 512);
    };
  }
...
var _sfc_main = vue.defineComponent(_objectSpread$1(_objectSpread$1({}, __default__), {}, {
  props: {
    id: null,
    title: {
      type: [String, Boolean, Function],
  ...
  setup: function setup7(__props, _ref) {
    ...
    var max = vue.ref(false);
    var min = vue.ref(false);
    var id = vue.ref(props.id || nextId());
    var layero = vue.ref(null);
    var type = calculateType(props.type);
    var area = vue.ref(calculateArea(props.type, props.area, props.offset));
    var offset = vue.ref(calculateOffset(props.offset, area.value, props.type));
    var contentHeight = vue.ref(calculateContent(props.title, area.value[1], props.btn, type, props.isMessage));
    var index2 = vue.computed(function() {
      var _props$zIndex;
      return (_props$zIndex = props.zIndex) !== null && _props$zIndex !== void 0 ? _props$zIndex : vue.inject(zIndexKey, 99999);
    });
    var visible = vue.ref(false);
    var first = vue.ref(true);
    var w = vue.ref(area.value[0]);
    var h2 = vue.ref(area.value[1]);
    var t = vue.ref(offset.value[0]);
    var l = vue.ref(offset.value[1]);
    var _w = vue.ref(area.value[0]);
    var _h = vue.ref(area.value[0]);
    var _t = vue.ref(offset.value[0]);
    var _l = vue.ref(offset.value[1]);
    var firstOpenDelayCalculation = function firstOpenDelayCalculation2() {
      vue.nextTick(/* @__PURE__ */ _asyncToGenerator(/* @__PURE__ */ regenerator.mark(function _callee() {
        return regenerator.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
    ...
    var enterActiveClass = vue.computed(function() {
      if (type === 4) {
    ...
    var leaveActiveClass = vue.computed(function() {
      if (type === 4) {
    ...
    var shadeVisible = vue.computed(function() {
      return visible.value && props.shade && !min.value;
    });
    var showResize = vue.computed(function() {
    ...
    var resetCalculationPohtosArea = function resetCalculationPohtosArea2(index22) {
      vue.nextTick(/* @__PURE__ */ _asyncToGenerator(/* @__PURE__ */ regenerator.mark(function _callee2() {
    ...
    return function(_ctx, _cache) {
      return vue.openBlock(), vue.createElementBlock("div", null, [vue.createVNode(_sfc_main$7, {
        index: vue.unref(index2),
        visible: vue.unref(shadeVisible),
        opacity: __props.shadeOpacity,
        onShadeClick: shadeHandle
      }, null, 8, ["index", "visible", "opacity"]), vue.createVNode(vue.Transition, {
        "enter-active-class": vue.unref(enterActiveClass),
        "leave-active-class": vue.unref(leaveActiveClass)
      }, {
        default: vue.withCtx(function() {
          return [visible.value ? (vue.openBlock(), vue.createElementBlock("div", {
            ...
            ref_key: "layero",
            ref: layero,
            class: vue.normalizeClass(["layui-layer layui-layer-border", vue.unref(boxClasses)]),
            style: vue.normalizeStyle(vue.unref(styles))
          }, [vue.unref(showTitle) ? (vue.openBlock(), vue.createBlock(_sfc_main$5, {
            key: 0,
            title: __props.title
          }, null, 8, ["title"])) : vue.createCommentVNode("", true), vue.createElementVNode("div", {
            class: vue.normalizeClass(["layui-layer-content", vue.unref(contentClasses)]),
            style: vue.normalizeStyle({
              height: contentHeight.value
            })
          }, [vue.unref(type) === 0 || vue.unref(type) === 1 || vue.unref(type) === 4 ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, {
            key: 0
          }, [__props.icon ? (vue.openBlock(), vue.createElementBlock("i", {
            key: 0,
            class: vue.normalizeClass(vue.unref(iconClass))
          }, null, 2)) : vue.createCommentVNode("", true), vue.unref(slots).default ? vue.renderSlot(_ctx.$slots, "default", {
            key: 1
          }) : (vue.openBlock(), vue.createElementBlock(vue.Fragment, {
            key: 2
          }, [__props.isHtmlFragment ? (vue.openBlock(), vue.createElementBlock("span", {
            key: 0,
            innerHTML: renderContent(props.content)
          }, null, 8, _hoisted_1)) : (vue.openBlock(), vue.createElementBlock(vue.Fragment, {
            key: 1
          }, [vue.createTextVNode(vue.toDisplayString(renderContent(props.content)), 1)], 64))], 64))], 64)) : vue.createCommentVNode("", true), vue.unref(type) === 2 ? (vue.openBlock(), vue.createBlock(_sfc_main$6, {
            key: 1,
            src: props.content
          }, null, 8, ["src"])) : vue.createCommentVNode("", true), vue.unref(type) === 5 ? (vue.openBlock(), vue.createBlock(_sfc_main$2, {
            key: 2,
            imgList: props.imgList,
            startIndex: props.startIndex,
            onResetCalculationPohtosArea: resetCalculationPohtosArea
          }, null, 8, ["imgList", "startIndex"])) : vue.createCommentVNode("", true), vue.unref(type) === 6 ? (vue.openBlock(), vue.createBlock(_sfc_main$1, {
            key: 3,
            onClose: closeHandle,
            title: props.title,
            ...
            icon: props.icon,
            iconClass: vue.unref(iconClass)
          }, null, 8, ["title", "content", "isHtmlFragment", "icon", "iconClass"])) : vue.createCommentVNode("", true)], 6), vue.unref(type) != 3 && vue.unref(type) != 5 && vue.unref(type) != 6 ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_2, [__props.maxmin && !max.value ? (vue.openBlock(), vue.createElementBlock("a", {
            key: 0,
            class: vue.normalizeClass(["layui-layer-min", [min.value ? "layui-layer-ico layui-layer-maxmin" : ""]]),
            href: "javascript:;",
            onClick: minHandle
          }, [!min.value ? (vue.openBlock(), vue.createElementBlock("cite", _hoisted_3)) : vue.createCommentVNode("", true)], 2)) : vue.createCommentVNode("", true), __props.maxmin && !min.value ? (vue.openBlock(), vue.createElementBlock("a", {
            key: 1,
            class: vue.normalizeClass(["layui-layer-ico layui-layer-max", [max.value ? "layui-layer-maxmin" : ""]]),
            href: "javascript:;",
            onClick: maxHandle
          }, null, 2)) : vue.createCommentVNode("", true), __props.closeBtn != false ? (vue.openBlock(), vue.createBlock(_sfc_main$4, {
            key: 2,
            "close-btn": __props.closeBtn,
            onCloseHandle: closeHandle
          }, null, 8, ["close-btn"])) : vue.createCommentVNode("", true)])) : vue.createCommentVNode("", true), (__props.btn && __props.btn.length > 0 || vue.unref(type) === 0) && !__props.isMessage ? (vue.openBlock(), vue.createElementBlock("div", {
            key: 2,
            class: vue.normalizeClass(["layui-layer-btn", ["layui-layer-btn-".concat(__props.btnAlign)]])
          }, [__props.btn && __props.btn.length > 0 ? (vue.openBlock(true), vue.createElementBlock(vue.Fragment, {
            key: 0
          }, vue.renderList(__props.btn, function(b, index22) {
            return vue.openBlock(), vue.createElementBlock("a", {
              key: index22,
              class: vue.normalizeClass(["layui-layer-btn".concat(index22)]),
              onClick: function onClick($event) {
                return b.callback(id.value);
              }
            }, vue.toDisplayString(b.text), 11, _hoisted_4);
          }), 128)) : (vue.openBlock(), vue.createElementBlock(vue.Fragment, {
            key: 1
          }, [vue.unref(type) === 0 ? (vue.openBlock(), vue.createElementBlock("a", {
            key: 0,
            class: "layui-layer-btn0",
            onClick: _cache[0] || (_cache[0] = function($event) {
              return yesHandle();
            })
          }, vue.toDisplayString(__props.yesText), 1)) : vue.createCommentVNode("", true)], 64))], 2)) : vue.createCommentVNode("", true), vue.unref(showResize) ? (vue.openBlock(), vue.createBlock(Resize, {
            key: 3
          })) : vue.createCommentVNode("", true)], 6)) : vue.createCommentVNode("", true)];
        }),
        _: 3
...
var layer = {
  ...
  create: function create(option, defaultOption, callback) {
    ...
    var modalInstance = vue.h(_sfc_main, _objectSpread(_objectSpread({}, options), {}, {
      isFunction: true,
    ...
    vue.render(modalInstance, modalContainer);
  ...
  close: function close(id) {
    if (id != null && isExist(id)) {
      ...
      setTimeout(function() {
        vue.render(null, instance.modalContainer);
  ...
  closeAll: function closeAll() {
    layerInstance.forEach(function(item) {
      ...
      setTimeout(function() {
        vue.render(null, item.modalContainer);
...
exports.LayLayer = _sfc_main;
exports.default = index;
exports.layer = layer;
//# sourceMappingURL=layer-vue.es.js.map
